  ...
  <WhatWeDo/>
    ...
    <div className="callus">
      ...
      <div className="xl:w-[85%] w-[90%] mx-auto py-8">
        <h1 className='text-3xl text-center py-5'>Some Of The States We Serve</h1>
        <p className='text-text-color leading-8'> <span className='text-green-700'>
           Georgia Truck Dispatching | North Carolina Truck Dispatching </span>| South Carolina Truck Dispatching |< span className='text-green-700'> New York Truck Dispatching </span>| Indiana Truck Dispatching | <span className='text-green-700'>Virginia Truck Dispatching </span>| California Truck Dispatching | Florida Truck Dispatching | Illinois Truck Dispatching | Missouri Truck Dispatching</p>
      </div>
       {/* <ButtonCom
